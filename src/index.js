	...
	async fetch(request, env, ctx) {
		...
		<html lang="en">
			<head>
				...
				<link rel="icon" href="/delteams-svg-optimized.svg">
			</head>
			<header>
				<div id="header-left">
					<button id="homepage-btn" class="btn_nil"><img id="edt-logo" src="/delteams-svg-optimized.svg" alt="Our logo. Click to access homepage."></button>
				</div>
