...
export default {
	async fetch(request, env, ctx) {
		...
		if (url.pathname === "../public/style.css") {
			const cssContent = `
		...
		<html lang="en">
			<head>
				...
				<link rel="icon" href="../public/delteams-svg-optimized.svg">
			</head>
			<header>
				<div id="header-left">
					<button id="homepage-btn" class="btn_nil"><img id="edt-logo" src="../public/delteams-svg-optimized.svg" alt="Our logo. Click to access homepage."></button>
				</div>
			...
			<body>
				...
				<script type="text/javascript" src="../public/about.js"></script>
			</body>
			<footer>
				<div id="footer-left">
